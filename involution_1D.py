...
class Involution1d(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        # print("Expected number of output channels:", self.kernel_size[0] * self.kernel_size[1] * self.groups)
        # print("Actual number of output channels:", self.span_mapping.out_channels)
